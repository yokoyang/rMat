...
//        return -1;
//    }
    diff_list_node* list = malloc(sizeof(diff_list_node));
    list->next = NULL; list->data = NULL; list->end = list;
    row_num = parse_file(ifp_readCount, ifp_geneExpre, list, title_element_list, (int)REP_NUM);
